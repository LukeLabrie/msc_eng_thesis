...
# CORE
# fuel nodes
dc_f1 = dT_bulkFlow(W_f, m_f_c/4, (hx_fh1_f2(t-tau_hx_c_f)+hx_fh2_f2(t-tau_hx_c_f))/2,c_f1()) + dT_internal(k_f1/2, P, mcp_f_c/4, n()) + dT_convective([c_t1()],c_f1(),[hA_ft_c/mcp_f_c]) 
dc_f2 = dT_bulkFlow(W_f, m_f_c/4, c_f1(), c_f2()) + dT_internal(k_f2/2, P, mcp_f_c/4, n()) + dT_convective([c_t1()],c_f2(),[hA_ft_c/mcp_f_c]) 
dc_f3 = dT_bulkFlow(W_f, m_f_c/4, c_f2(), c_f3()) + dT_internal(k_f1/2, P, mcp_f_c/4, n()) + dT_convective([c_t1()],c_f3(),[hA_ft_c/mcp_f_c]) 
dc_f4 = dT_bulkFlow(W_f, m_f_c/4, c_f3(), c_f4()) + dT_internal(k_f2/2, P, mcp_f_c/4, n()) + dT_convective([c_t1()],c_f4(),[hA_ft_c/mcp_f_c]) 
